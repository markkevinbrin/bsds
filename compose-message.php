...
<head>
  ...
  <title>Barangay Helpdesk System with SMS Features for Text Blast Announcements | Compose Message</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Barangay Helpdesk System with SMS Features for Text Blast Announcements</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="message-inbox.html" class="nav-link">
                  <i class="far fa-comments nav-icon"></i>
                  <p>Inbox</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="compose-message.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <a href="#" class="btn btn-primary btn-block mb-3">Back to Dashboard</a>
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" placeholder="Enter message here..."></textarea>
                </div>
              </div>
              <!-- /.card-body -->
              <div class="card-footer">
                <div class="float-right">
                  <button id="sendgrpmsg" class="btn btn-primary"><i class="far fa-envelope"></i> Send</button>
                </div>
              </div>
              <!-- /.card-footer -->
            </div>
...
<!-- CUSTOM GROUP MESSAGE SCRIPT -->

<script type="text/javascript">

    $("#sendgrpmsg").click(function(){
